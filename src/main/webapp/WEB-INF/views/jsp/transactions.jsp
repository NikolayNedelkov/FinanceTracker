						...
						<div class="col-lg-12">
							<div class="well">
								...
								<button type="button" class="btn btn-primary"
									id="addtransaction">Add a new transaction</button>
							</div>
						</div>
						<!-- col-lg-12 -->
					</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="addExpenseForm" action="./transactions" method="post">
						...
						<div class="expense_amt">
							...
							<input type="number" class="form-control" id="addexpense_amt" name="amount">
						</div>

						<div class="expense_name">
							<div class="inline modalcss">Choose Account:</div>
							<select class="form-control" class="addExpense_category_option" name="accountSelect">
								<option value="general">General</option>
								<option value="personal">Personal</option>
								<option value="food">Food</option>
							</select>
						...
						<div class="expense_name">
							...
							<select class="form-control" class="addExpense_category_option" name = "typeSelect">
